    ...
    <div className="flex flex-col h-full min-h-[calc(100vh-8rem)] md:min-h-0 page-enter">
      ...
      <div className="mb-4">
        ...
        <p className="text-muted text-sm">
          {users.length > 0
            ? `${users.length} people ready to swap skills`
        ...
        {users.length === 0 ? (
          ...
          >
            ...
            <p className="text-muted text-sm mb-6">
              ...
              Check your requests to follow up.
            </p>
          ...
          <>
            ...
            <div className="relative w-full max-w-sm" style={{ height: 480 }}>
              ...
              {users.length > 2 && (
                <div className="absolute inset-0 rounded-3xl bg-orange-100 border border-orange-200 scale-90 translate-y-8 pointer-events-none" />
              )}
              {users.length > 1 && (
            ...
            <div className="flex items-center gap-5 mt-6">
              ...
              <button
                onClick={() => topUser && handleLike(topUser)}
